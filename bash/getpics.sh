...
test -f ~/public_html/pics/pics.tgz || wget -q -O ~/public_html/pics/pics.tgz https://zonzorp.net/pics.tgz
# unpack the downloaded zipfile if the download succeeded - assumes we have an unzip command on this system
test -f ~/public_html/pics/pics.tgz && unzip -d ~/public_html/pics/pics.tgz -o -q ~/public_html/pics/pics.tgz
